...
export function dataBoundaryFlowEvents(trace: DataBoundaryScenarioTrace): AgentFlowEvent[] {
  ...
  return [
    ...
    { ...base, id: `${turnId}-intent`, event: "state:intent", phase: "intent", from: "main_agent", to: "main_agent", label: "정규식 API 라우팅", detail: `apiId=${trace.apiId} | router=regex`, branch: "data" },
    { ...base, id: `${turnId}-intent-result`, event: "state:intent_result", phase: "intent", from: "main_agent", to: "main_agent", label: "API 라우팅 결과", detail: `apiId=${trace.apiId} | router=regex`, branch: "data" },
